          ...
          <div className="row">
            <div className="col-sm-6">
              ...
              <select
                ...
                onChange={(evt) => onThemeChange(((evt.target as HTMLSelectElement).value as unknown) as ThemeNames)}
              >
            ...
            <div className="col-sm-6">
              ...
              <select
                ...
                onChange={(evt) =>
                  onTransitionChange(((evt.target as HTMLSelectElement).value as unknown) as TransitionNames)
                }
              >
          ...
          <div className="col-sm-6">
            ...
            <Switch
              ...
              onChange={(event) => {
                ...
                setNotification({
                  ...notification,
                  image: (event.target as HTMLInputElement).checked ? `${baseUrl}static/images/image-1.png` : undefined,
                })
              }}
            />
          </div>
